...
This document provides comprehensive architecture guidelines, conventions, and instructions for AI agents (including Gemini, Jules, and coding assistants) interacting with and contributing to the QueueBoard codebase.
